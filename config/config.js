...
const settings = {
  ...
  AUTO_REF: process.env.AUTO_REF ? process.env.AUTO_REF.toLowerCase() === "true" : false,
  ...
  AUTO_CREATE_EMAIL: process.env.AUTO_CREATE_EMAIL ? process.env.AUTO_CREATE_EMAIL.toLowerCase() === "true" : false,
  ...
  REF_CODE: process.env.REF_CODE ? process.env.REF_CODE : "WC5GHPCMD",
